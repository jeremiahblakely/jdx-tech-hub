...
/**
 * @typedef {Object} ImplementationDetail
 * @property {string} type - 'file' | 'config' | 'schema' | 'endpoint' | 'test'
...
/**
 * @typedef {Object} FieldImplementation
 * @property {string} field
 * @property {string} type
 * @property {'complete' | 'pending' | 'blocked'} status
 * @property {string} [description]
 * @property {Object} [validation]
 */

/**
 * @typedef {Object} EndpointCreated
 * @property {string} endpoint
 * @property {HTTPMethod} method
 * @property {'working' | 'not-built' | 'broken' | 'testing'} status
 * @property {string} [description]
...
/**
 * @typedef {Object} TimeTracking
 * @property {number} estimatedMinutes
 * @property {number} actualMinutes
 * @property {string} [startedAt]
 * @property {string} [completedAt]
 * @property {string[]} [workSessions]
 */
 ...
 * @property {ImplementationDetail[]} [details]
 * @property {FileModification[]} [filesModified]
 * @property {string} [completedAt]
 ...
 * @property {TimeTracking} timeTracking
 * @property {string} [description]
 * @property {ChecklistItem[]} [checklist]
 * @property {CredentialItem[]} [credentials]
 * @property {EndpointItem[]} [endpoints]
 * @property {FileModification[]} [filesModified]
 * @property {FieldImplementation[]} [fieldsImplemented]
 * @property {EndpointCreated[]} [endpointsCreated]
